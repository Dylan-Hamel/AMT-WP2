...
public class DefaultApi {
     ...
     */
    public com.squareup.okhttp.Call badgesDeleteCall(String xGamificationToken, Integer id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call badgesDeleteValidateBeforeCall(String xGamificationToken, Integer id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling badgesDelete(Async)");
        }
        

        com.squareup.okhttp.Call call = badgesDeleteCall(xGamificationToken, id, progressListener, progressRequestListener);
        return call;
     ...
     */
    public void badgesDelete(String xGamificationToken, Integer id) throws ApiException {
        badgesDeleteWithHttpInfo(xGamificationToken, id);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> badgesDeleteWithHttpInfo(String xGamificationToken, Integer id) throws ApiException {
        com.squareup.okhttp.Call call = badgesDeleteValidateBeforeCall(xGamificationToken, id, null, null);
     ...
     */
    public com.squareup.okhttp.Call badgesDeleteAsync(String xGamificationToken, Integer id, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = badgesDeleteValidateBeforeCall(xGamificationToken, id, progressListener, progressRequestListener);
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RuleDTO rulesIdGet(String xGamificationToken, Integer id) throws ApiException {
        ApiResponse<RuleDTO> resp = rulesIdGetWithHttpInfo(xGamificationToken, id);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RuleDTO> rulesIdGetWithHttpInfo(String xGamificationToken, Integer id) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call rulesIdGetAsync(String xGamificationToken, Integer id, final ApiCallback<RuleDTO> callback) throws ApiException {
