...
import io.avalia.fruits.model.Event;
...
public class EventsApiController implements EventsApi {
    ...
    public ResponseEntity<Void> eventsPost(@ApiParam(value = "Required informations" ,required=true )  @Valid @RequestBody Event body) {
