...
import io.avalia.fruits.model.GamifiedApplication;
...
public class RegisterApiController implements RegisterApi {
    ...
    public ResponseEntity<Void> registerPost(@ApiParam(value = "Required informations" ,required=true )  @Valid @RequestBody GamifiedApplication body) {
