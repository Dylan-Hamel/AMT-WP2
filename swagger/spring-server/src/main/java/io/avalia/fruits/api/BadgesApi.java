...
public interface BadgesApi {
    ...
    @ApiOperation(value = "List all badges linked to current application", nickname = "badgesGet", notes = "", response = Badge.class, responseContainer = "List", tags={  })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Deletes specific badge", nickname = "badgesNameDelete", notes = "", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successfully done"),
        @ApiResponse(code = 404, message = "No such badge") })
    ...
    @ApiOperation(value = "Fetch specific badge", nickname = "badgesNameGet", notes = "", response = Badge.class, tags={  })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Update specific badge", nickname = "badgesNamePost", notes = "", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successfully done"),
        @ApiResponse(code = 404, message = "No such badge"),
        @ApiResponse(code = 409, message = "Badge already existing") })
    @RequestMapping(value = "/badges/{name}/",
        produces = { "application/json" }, 
        consumes = { "application/json" },
    ...
    @ApiOperation(value = "Create new badge", nickname = "badgesPost", notes = "", tags={  })
    @ApiResponses(value = { 
